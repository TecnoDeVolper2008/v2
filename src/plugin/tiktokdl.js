          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: `Qᴜᴇᴇɴ Aʟʏᴀ👸 ᴛɪᴋᴛᴏᴋ ᴅᴏᴡɴʟᴏᴅᴇʀ\n\n⚡️Title: ${currentResult.data.title}\n⚡️Author: ${currentResult.data.author.nickname}\n⚡️Views: ${currentResult.data.view}\n⚡️Duration: ${currentResult.data.duration}s\n`
              }),
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "> Qᴜᴇᴇɴ Aʟʏᴀ👸 ʙʏ ᴋᴀᴡᴅʜɪᴛʜᴀ ɴɪʀᴍᴀʟ"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                 ...(await prepareWAMessageMedia({ image: { url: `https://telegra.ph/file/9a760094f13afad3b6577.jpg` } }, { upload: Matrix.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> Qᴜᴇᴇɴ Aʟʏᴀ👸 ʙʏ ᴋᴀᴡᴅʜɪᴛʜᴀ ɴɪʀᴍᴀʟ' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> Qᴜᴇᴇɴ Aʟʏᴀ👸 ʙʏ ᴋᴀᴡᴅʜɪᴛʜᴀ ɴɪʀᴍᴀʟ' };
          }
